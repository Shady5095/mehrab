...
class ChangePasswordScreenBodyTeacher extends StatelessWidget {
  const ChangePasswordScreenBodyTeacher({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = context.read<MyTeacherProfileCubit>();
    return Form(
