...
import 'package:mehrab/features/my_profile/presentation/manager/my_teacher_profile_cubit.dart';
import 'package:mehrab/features/my_profile/presentation/manager/my_teacher_profile_state.dart';
...
class MyTeacherProfileProfilePhotoBuild extends StatelessWidget {
  const MyTeacherProfileProfilePhotoBuild({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = MyTeacherProfileCubit.instance(context);
    return BlocBuilder<MyTeacherProfileCubit, MyTeacherProfileState>(
