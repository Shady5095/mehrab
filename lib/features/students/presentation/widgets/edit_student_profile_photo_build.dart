...
class EditStudentProfilePhotoBuild extends StatelessWidget {
  const EditStudentProfilePhotoBuild({super.key});

  @override
  Widget build(BuildContext context) {
    final cubit = EditStudentCubit.get(context);
    return BlocBuilder<EditStudentCubit, EditStudentState>(
