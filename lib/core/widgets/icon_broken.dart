...
class IconBroken {
  ...
  static const IconData Arrow___Down_2 = IconData(
    0xe904,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Down_3 = IconData(
    0xe905,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Down_Circle = IconData(
    0xe906,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Down_Square = IconData(
    0xe907,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Down = IconData(
    0xe908,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Left_2 = IconData(
    0xe909,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Left_3 = IconData(
    0xe90a,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Left_Circle = IconData(
    0xe90b,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Left_Square = IconData(
    0xe90c,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Left = IconData(
    0xe90d,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Right_2 = IconData(
    0xe90e,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Right_3 = IconData(
    0xe90f,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Right_Circle = IconData(
    0xe910,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Right_Square = IconData(
    0xe911,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Right = IconData(
    0xe912,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Up_2 = IconData(
    0xe913,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Up_3 = IconData(
    0xe914,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Up_Circle = IconData(
    0xe915,
    fontFamily: _fontFamily,
  );
  static const IconData Arrow___Up_Square = IconData(
    0xe916,
    fontFamily: _fontFamily,
  );
